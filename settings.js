...
if(process.env.LAUNCHMODE || process.env.LAUNCHMODE === "dev"){
    console.log("USERNAME : ",process.env.NODE_RED_USERNAME);
    console.log("PASSWORD : ",process.env.NODE_RED_PASSWORD);
...
settings.mongoAppname = process.env.APPNAME || 'nodered';
